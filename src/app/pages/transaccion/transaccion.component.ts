...
export class TransaccionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      this.service.getEstadoTransaccionWompi(this.transactionID, (wompiResponse) => {
        ...
        this.valorPago = wompiResponse.data.amount_in_cents;
        this.fechaPago = wompiResponse.data.created_at;
        this.desdePago = wompiResponse.data.payment_method_type;
        this.productoPago = wompiResponse.data.payment_method.payment_description;
  ...
  downloadPDF() {
    ...
    html2canvas(DATA, options).then((canvas) => {
      ...
      this.genPDF = false;
      docResult.save(`transaction_${this.transactionID}_${new Date().toISOString()}.pdf`);
    });
  }
}
